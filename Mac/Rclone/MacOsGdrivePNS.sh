...
#
# 20260825 - MacOsGdrivePNS.sh - Testado e funcional.
#

# ========================
# CONFIGURAÇÃO DE CAMINHOS
# ========================
LOCAL_DIR="/Users/paulonogueirasilva/gdrive_pns"
REMOTE_DIR="gdrive_pns:"
...
if pgrep -x "rclone" > /dev/null; then
  echo "Rclone já está em execução de Paulo Nogueira Silva <--> Local Mac"
...
if [ -t 0 ]; then
  echo -n "Deseja iniciar o rclone Paulo Nogueira Silva <--> Local Mac agora? [y/N]: "
  read -r resposta
  if [[ ! "$resposta" =~ ^[Yy]$ ]]; then
